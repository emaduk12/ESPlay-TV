const allowedCodes = {
  "G4X9B7LT": 10,                          // 10 seconds
  "T2V6Q1ZR": 30 * 24 * 60 * 60,           // 30 days
  "L7P0M2XA": 365 * 24 * 60 * 60,           // 1 year
  "C1W9R6EQ": 5 * 365 * 24 * 60 * 60,       // 5 years
  "EMAD2324": 50 * 365 * 24 * 60 * 60       // 50 years (treated as unlimited)
};
...
// Add session timer element to header
...
// Initialize app if session active
if (checkSession()) {
  initApp();
}